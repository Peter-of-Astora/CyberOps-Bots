...
Agent.save_model("IPPO.pth")  # Save the model to model_dir.
...
# agent_test = IPPO_Agents(config=configs, envs=envs)
# agent_test.load_model("/root/work/project/models/IPPO")  # 如果不指定后一个model参数，自动会载入最新的
